...
if (isset($_POST['backup']) && !empty($_POST['password'])) {
    // cleanEntry fonksiyonu, parola gibi kullanıcı girdilerini güvenlik açısından kontrol eder.
    // Bu fonksiyon, komut enjeksiyonu saldırılarını önlemek amacıyla, girdide ';', '&', '|', '$' gibi
    // tehlikeli olabilecek karakterlerin bulunup bulunmadığını denetler.
    // Eğer yasaklı bir karakter tespit edilirse, fonksiyon 'false' döndürür ve işlem iptal edilir.
    // Girdi temiz ise, olduğu gibi geri döndürülür.
